...
Světlý nebo tmavý motiv se přepíná tlačítkem v hlavičce (Auto → Světlý → Tmavý). Rozpracované kolo (zkouška, opakování, kartičky) se po obnovení stránky vrátí na stejné místo, pokud je mladší než 24 hodin. Postup i volba motivu se ukládají jen v `localStorage` prohlížeče — žádný server ani databáze.
