...
const CORE = [
  ...
  'img/plane-nestovice.jpg', 'img/zardenky.jpg', 'img/borelioza.jpg', 'img/opar.jpg', 'img/koprivka.jpg',
  ...['figs', 'bank1', 'bank2', 'bank3', 'bank4', 'bank5', 'revize', 'recall', 'coverage', 'app'].map(f => `${f}.js?v=${VERSION}`)
];
